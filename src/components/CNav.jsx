...
<nav class="bg-[white] ml-5 text-blackish text-sm border-gray-200 dark:bg-gray-900">
...
<a href="/home" class="block py-2 pl-3 pr-4 text-black bg-blue-700 rounded md:bg-transparent md:text-black md:p-0 dark:text-white md:dark:text-black" aria-current="page">HOME</a>
                            ...
                            <li>
                                <a href="/photographer" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-black md:p-0 dark:text-white md:dark:text-black hover:text-white">PHOTOGRAPHER</a>
                            </li>
                            <li>
                            ...
                            <li>
                                <a href="contact" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-white md:p-0 dark:text-white md:dark:text-black hover:text-white">CONTACT</a>
                            </li>
                        </ul>
                    </div>
                </div>
