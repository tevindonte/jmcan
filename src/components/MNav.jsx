...
<a href="/home" class="block py-2 pl-3 pr-4 text-black bg-blue-700 rounded md:bg-transparent md:text-black md:p-0 dark:text-white md:dark:text-black" aria-current="page">HOME</a>
                            ...
                            <li className=''>
                                <a href="/model" class="block py-2 pl-3 pr-4 text-white bg-blue-700 rounded md:bg-transparent md:text-white md:p-0 dark:text-white md:dark:text-black hover:text-white">MODEL</a>
                            </li>
                            <li>
