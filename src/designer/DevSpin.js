...
const InteractiveMarquee = () => {
  ...
  return (
    <div className="marquee-scrollbar">
      <motion.div className="marquee" ref={marquee} style={{ skewX }} onWheel={onWheel} drag="x" dragConstraints={{ left: 0, right: 0 }} onDragStart={onDragStart} onDrag={onDrag} onDragEnd={onDragEnd} dragElastic={0.000001}>
...
export default function DevSpin() {
