...
export default function Package() {
  ...
  return (
    ...
    >
      ...
      <Link to="/designer/logo" className="text-white border border-white hover:border-redish dark:border-gray-900 dark:bg-gray-900 dark:hover:border-gray-700 bg-white focus:ring-4 focus:outline-none focus:ring-gray-300 rounded-full text-sm font-medium px-5 py-2.5 text-center mr-3 mb-3 dark:text-white dark:focus:ring-gray-800 bg-transparent">LOGO</Link>
